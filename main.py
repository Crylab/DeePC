...
def pid_parallel_run_lis(list_in: list, var_param: str):
        parameters = {
...
def pid_parallel_run_loose_lis(list_in: list, var_param: str):
    parameters = {
        "heading_loop": [2.0, 0.0, 0.0],
        "velocity_loop": [3.0, 0.0, 0.0],
        "direction_loop": [0.1, 0.0, 0.0],
...
def deepc_parallel_run_lis(list_in: list, var_param: str, N:int):
    parameters = {
...
def mpc_parallel_run_lis(list_in: list, var_param: str):
    parameters = {
        'Q': [1, 1, 1, 100],
        'R': [0.1, 0.1],
        'prediction_horizon': 8,
...
def abu_dhabi_chart():
    ...
    def mpc_parallel_run_abu(list_in: list, var_param: str):
        parameters = {
            'track': "ABU_F2.csv",
            'Q': [1, 1, 1, 100],
            'R': [0.1, 0.1],
    ...
    def pid_parallel_run_abu(list_in: list, var_param: str):
        parameters = {
            "heading_loop": [2.0, 0.0, 0.0],
            "velocity_loop": [3.0, 0.0, 0.0],
            "direction_loop": [0.1, 0.0, 0.0],
    ...
    def pid_parallel_run_loose_abu(list_in: list, var_param: str):
        parameters = {
            "heading_loop": [2.0, 0.0, 0.0],
            "velocity_loop": [3.0, 0.0, 0.0],
            "direction_loop": [0.1, 0.0, 0.0],
    ...
    def deepc_parallel_run_abu(list_in: list, var_param: str, N:int):
        parameters = {
            'lambda_g': 5.0*float(N)/100.0,
            'lambda_y': [2e2] * 4,
            'N': N,
    ...
    pid_res = pid_parallel_run_abu(list_in, "pacejka_D")
    pid_res_loose = pid_parallel_run_loose_abu(list_in, "pacejka_D")
    deepc_res50, deepc_sig_50 = deepc_parallel_run_abu(list_in, "pacejka_D", 50)
    deepc_res100, deepc_sig_100 = deepc_parallel_run_abu(list_in, "pacejka_D", 100)
    deepc_res200, deepc_sig_200 = deepc_parallel_run_abu(list_in, "pacejka_D", 200)
    deepc_res400, deepc_sig_400 = deepc_parallel_run_abu(list_in, "pacejka_D", 400)
    mpc_res = mpc_parallel_run_abu(list_in, "pacejka_D")
